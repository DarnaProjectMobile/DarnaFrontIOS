...
final class PropertyService {
    ...
    // ✅ Centralized server URL — replace with votre IP dans ServerConfig
    ...
    func fetchProperties() async throws -> [Property] {
        ...
        // Les utilisateurs peuvent voir les logements sans être connectés
        ...
        if !(200..<300).contains(httpResponse.statusCode) {
            ...
            // Si le serveur exige l'authentification (401), on lève une erreur spécifique
            if httpResponse.statusCode == 401 {
                print("⚠️ Le backend exige l'authentification pour /annonces")
                print("💡 Solution: Rendre l'endpoint public dans le backend ou se connecter")
        ...
        do {
            ...
            print("✅ Successfully fetched \(properties.count) properties from backend")
            return properties
        } catch {
